...
const ProductModalsJsx = ({ item, setShowModal, setScrollPosition, scrollPosition }) => {
    const { name, price, description, image, id } = item;
    console.log(id, "Moeez")
        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50 bg-gray-800 bg-opacity-50">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden max-w-3xl">
                <div className="relative p-4">
                    <button onClick={onCloseHandler} className="absolute top-3 right-3 text-gray-500 hover:text-gray-700">
